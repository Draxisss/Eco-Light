...
| Total                             |          | 34           | C'est seulement si vous achetez toutes les pièces, on peut faire de la récup sur certain composants (le convertisseur 220V AC vers 5V DC d'un chargeur, le bouton poussoir d'un petit appareil, les leds d'un jouet pour bébé, les résistances d'un autre projet et les fils d'un starter pack arduino) pour ma part |
