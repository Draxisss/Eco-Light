...
Il faut ensuite récupérer le [code](assets/code/codeesp32.ino) pour l'ESP32 et le flasher sur votre microcontrôleur via Arduino IDE (un logiciel de programmation pour tout ces petits microcontrôleur)
